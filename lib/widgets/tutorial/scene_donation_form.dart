    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          // 실제 pet_management.dart와 동일 — 종합백신/예방약/중성화 행 자체가
          // 상태+일자 통합 표시. 별도 ✓ 상태 행 안 둠. 날짜 포맷 yyyy.MM.dd.
          child: Column(
            children: [
              ...
              _row(Icons.vaccines_outlined, '종합백신', '2025.08.14'),
              _row(Icons.science_outlined, '항체검사', '2026.01.22'),
              _row(Icons.medication_outlined, '예방약', '2026.04.10'),
              _row(Icons.verified_user_outlined, '중성화', '2024.09.12'),
